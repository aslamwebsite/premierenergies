...
import Leadership05 from './images/Jasveen-Saluja.png'
      ...
      <div className='web-conainer'>
        ...
        <div className='smallcirclerightdark'></div>
                <div className='title centerheading'>
                  ...
                  <span className='colorborder'><em></em></span>
                    <h2 data-aos="fade-down" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">Overview</h2>
                  </div>
                  </div>
                  ...
                  <div className='col-12'>
                    <div className='row'>
                      <div className='col-md-6'>
                        <p data-aos="fade-up" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">The year was 1995, when Shri Surendarpal Singh Saluja established Premiere Energies with the goal to harness the sun’s energy by incorporating it into solar cells and modules. </p>
    ...
    <div className='infragallery pb-0'>
      ...
      <div className='homeslider'>
          <img src={Gallery05} />
                    ...
                    <TabPanel>
                    <div className='gallery' data-aos="fade-up" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">
                    <iframe  src="https://www.youtube.com/embed/i4ib6Hd2ydg?rel=0" title="Premier Energies - A glimpse into our journey" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                    </TabPanel>
                    </Tabs>
